...
public class Account_01_Login_AbstractPage_01 {
	WebDriver driver;
    ...
    //Kiểm tra login thành công
        ...
        abstractPage.sendkeyToElement(driver,"ShopEmail", "lienltb@ghtk.vn");
        //driver.findElement(By.id("ShopEmail")).sendKeys("lienltb@ghtk.vn");
        //3. Điền password
        System.out.println("Login - STEP 3: Input pw into textbox");
        abstractPage.sendkeyToElement(driver,"ShopPassword", "shoptét12345");
